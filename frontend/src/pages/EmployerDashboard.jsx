      ...
      <aside className="w-72 bg-white border-r border-slate-200 flex flex-col shadow-sm z-30">
        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50/50">
          <div className="flex items-center gap-3 p-2 mb-4">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-sm border-2 border-white shadow-sm">
          ...
          <div className="flex gap-2">
            <button 
              ...
              className="flex-1 flex items-center justify-center py-2 rounded-lg border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 transition-all shadow-sm"
            >
              <UserCircle size={16} />
            </button>
            <button 
              onClick={logout}
              className="flex-1 flex items-center justify-center py-2 rounded-lg border border-rose-100 bg-rose-50 text-rose-600 hover:bg-rose-600 hover:text-white transition-all shadow-sm"
            >
              <LogOut size={16} />
            </button>
          </div>
      ...
      <main className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <header className={`h-20 flex items-center justify-between px-10 shrink-0 z-20 transition-colors duration-300 ${
          ...
          <div className="flex items-center gap-5">
            ...
            <button className="bg-blue-600 text-white px-5 py-2 rounded-xl text-sm font-bold hover:bg-blue-700 transition-all shadow-md shadow-blue-100 hover:-translate-y-0.5 active:scale-95">
              Post New Job
            </button>
          </div>
        </header>
        ...
        <div className={`flex-1 overflow-y-auto custom-scrollbar transition-colors duration-300 ${
          ...
          <div className="p-8 max-w-7xl mx-auto min-h-full">
            <div className={isApplicationsPage ? "" : "bg-white border border-slate-200 rounded-[2rem] shadow-sm p-8 min-h-[80vh]"}>
              <Routes>
